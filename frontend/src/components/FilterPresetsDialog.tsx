...
export default function FilterPresetsDialog({ open, onClose, pageKey, currentFilters, onLoadPreset, activePresetName }: FilterPresetsDialogProps) {
 ...
 return (
  <>
   <Dialog open={open} onClose={onClose} maxWidth='sm' fullWidth>
    ...
    <DialogContent>
     <Box mb={2}>
      <Button variant='contained' startIcon={<Save />} onClick={() => setShowSaveDialog(true)} fullWidth>
